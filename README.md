...
```bash
mkdir -p .claude/skills && curl -L https://github.com/daht-mad/log-update/archive/master.tar.gz | tar -xz --strip-components=1 -C . "log-update-master/.claude"
```
...
cp -r log-update/.claude/skills/log-update .claude/skills/
```
